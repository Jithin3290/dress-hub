// src/components/RecentlyWatched/RecentlyWatched.jsx
import React from "react";
import { useSelector, useDispatch } from "react-redux";
import { useNavigate } from "react-router-dom";
import { removeRecentlyWatched, clearRecentlyWatched } from "../../Redux/Slices/recentlywatchedSlice";

function RecentlyWatched() {
  const recentlyWatched = useSelector((s) => s.recentlyWatched || []);
    ...
    <div className="max-w-7xl mx-auto px-6 py-16 bg-gradient-to-br from-slate-50 to-gray-100 rounded-3xl my-12">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-2xl font-black text-gray-900">₹{item.new_price}</span>
              ...
              <div className="flex items-center gap-2 mt-4">
                ...
                <button
                  className="ml-auto text-sm text-rose-500"
                  onClick={() => dispatch(removeRecentlyWatched(item.id))}
                >
                  Remove
                </button>
              </div>
      ...
      <div className="mt-8 text-center">
        <button
          ...
          onClick={() => dispatch(clearRecentlyWatched())}
        >
          Clear
        </button>
      </div>
